// Function to create HTML for list items
    ...
    (async function() {
        try {
            ...
            if(pointsBalance.code == 200 && localStorage.getItem("isLogin")) {
